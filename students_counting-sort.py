...
def CountingSort(studentList,houseOrYear):
    ...
    C = [0 for i in range(rangeVal)]

    for i in range(len(studentList)):
        C[studentList[i].getIndex(houseOrYear)] +=1
    ...
    for i in range(len(studentList) - 1, -1, -1):
        ...
        #oList.insert(C[studentList[i].getIndex(houseOrYear)]-1,studentList[i])
        oList[C[studentList[i].getIndex(houseOrYear)]-1] = studentList[i]
        C[studentList[i].getIndex(houseOrYear)] -= 1
